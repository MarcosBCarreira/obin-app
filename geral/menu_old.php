...
<!-- menu.php -->
	...
	<div class="w3-top"   > 
		<div class="w3-row w3-white w3-padding" >
			...
			<a href="."><img src='imagens/logo.jpg' alt='Observatório de Inclusão' height="45" width="45">
			<p></p>
			<p></p>
			<p></p>
			<p></p>
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="socioListar.php" onclick="w3_show_nav('menuMedico')">Pessoas</a>
		</div>
	</div>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar" >
		<div class="w3-bar w3-hide-large w3-large">
			<a href="javascript:void(0)" onclick="w3_show_nav('menuMedico')"
			   class="w3-bar-item w3-button w3-theme w3-hover-light-gray w3-padding-16" style="width:50%">Pessoas</a>
		...
		<div id="menuMedico" class="myMenu">
			<div class="w3-container">
				<h3>Menu Associados</h3>
			</div>
			<a class="w3-bar-item w3-button" href="socioListar.php">Relação de Associados</a>
			<a class="w3-bar-item w3-button" href="socioIncluir.php">Cadastro de Associado</a>			
			<a class="w3-bar-item w3-button" href="pcdIncluir.php">Cadastro de PCD</a>
